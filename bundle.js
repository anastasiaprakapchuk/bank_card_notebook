...
/* harmony import */ var _js_Model_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./js/Model.js */ "./js/Model.js");
/* harmony import */ var _js_View_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./js/View.js */ "./js/View.js");
/* harmony import */ var _js_Controller_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./js/Controller.js */ "./js/Controller.js");
/* harmony import */ var _js_fetch_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./js/fetch.js */ "./js/fetch.js");
/* harmony import */ var _js_constants_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./js/constants.js */ "./js/constants.js");
...
function _buildApp() {
  _buildApp = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var currentList, initializationList;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            initializationList = function _initializationList(list) {
              //передаем функции cписок
              // создаём все три компонента
              var model = new _js_Model_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
              var view = new _js_View_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
              var controller = new _js_Controller_js__WEBPACK_IMPORTED_MODULE_3__["default"](); // увязываем компоненты друг с другом
              ...
              controller.start(model, containerApp, containerList); // инициируем первичное отображение
            ...
            _context.next = 3;
            return (0,_js_fetch_js__WEBPACK_IMPORTED_MODULE_4__.RequestGetCards)(_js_constants_js__WEBPACK_IMPORTED_MODULE_5__.wayDB);
...
var Controller = /*#__PURE__*/function () {
  ...
  _createClass(Controller, [{
    ...
    value: function start(model) {
      this.myModel = model;
      this.myElementApp = arguments.length <= 1 ? undefined : arguments[1];
      this.myElementList = arguments.length <= 2 ? undefined : arguments[2];
    }
  }, {
    key: "update",
    value: function update() {
      ...
      var cards = this.myElementList.querySelectorAll(".card");
      cards.forEach(function (item) {
        return item.querySelector(".remove").addEventListener("click", _this.notificationRemote);
      }); //Кликаем на одну из карт

      cards.forEach(function (item) {
        return item.querySelector(".column").addEventListener("click", _this.learnMoreCard);
      }); //Добавляем новую карту

      var addButton = this.myElementApp.querySelector("#addCard");
      addButton.addEventListener("click", this.addNewCard); //Сохраняем новую карту

      var newCard = this.myElementApp.querySelector("#newCard");
      var buttonSave = newCard.querySelector("#saveButton");
      buttonSave && buttonSave.addEventListener("click", this.validationNewCard); //Отменяем сохранение новой карты

      var buttonCancel = newCard.querySelector("#cancelButton");
      buttonCancel && buttonCancel.addEventListener("click", this.cancelNewCard); //Обработчик изменения полей формы

      _constants_js__WEBPACK_IMPORTED_MODULE_1__.dataForForm.forEach(function (element) {
        var field = newCard.querySelector("." + element.name);
        field && field.addEventListener("blur", _this.validateField);
        field && field.addEventListener("focus", _this.cancelValidateField);
      }); //Обработчик для поля 'Номер карты'

      var fieldNumberCard = newCard.querySelector(".number");
      fieldNumberCard && fieldNumberCard.addEventListener("input", this.initializationLogo);
    }
  }, {
    key: "notificationRemote",
    value: function () {
      var _notificationRemote = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(EO) {
        var message, parrent, id;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                EO.stopPropagation();
                message = confirm("Вы уверены, что хотите удалить карту?");
                ...
                parrent = EO.currentTarget.parentNode.parentNode;
                id = parrent.id;
                _context.next = 7;
                return this.myModel.removeCard(id);
      ...
      function notificationRemote(_x) {
        return _notificationRemote.apply(this, arguments);
      }
    ...
    key: "learnMoreCard",
    value: function learnMoreCard(EO) {
      var card = EO.currentTarget.parentNode;
    ...
    key: "validateField",
    value: function validateField(EO) {
      var field = EO.currentTarget;
      this.myModel.validateField(field);
      this.update();
    }
  }, {
    key: "cancelValidateField",
    value: function cancelValidateField(EO) {
      var field = EO.currentTarget;
      this.myModel.cancelValidateField(field);
    }
  }, {
    key: "validationNewCard",
    value: function () {
      var _validationNewCard = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(EO) {
        var formNewCard;
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                formNewCard = EO.currentTarget.parentNode;
                _context2.next = 3;
                return this.myModel.validationNewCard(formNewCard);
      ...
      function validationNewCard(_x2) {
        return _validationNewCard.apply(this, arguments);
      }

      return validationNewCard;
    }()
  }, {
    key: "cancelNewCard",
    value: function cancelNewCard() {
      this.myModel.cancelNewCard();
      this.update();
    }
  }, {
    key: "initializationLogo",
    value: function initializationLogo(EO) {
      var value = EO.currentTarget.value;
...
/* harmony import */ var regenerator_runtime_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! regenerator-runtime/runtime */ "./node_modules/regenerator-runtime/runtime.js");
/* harmony import */ var regenerator_runtime_runtime__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(regenerator_runtime_runtime__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _fetch_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./fetch.js */ "./js/fetch.js");
/* harmony import */ var _validation_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./validation.js */ "./js/validation.js");
...
var Model = /*#__PURE__*/function () {
  ...
  _createClass(Model, [{
    key: "start",
    value: function start(view, list) {
      this.myView = view;
      this.list = list;
    }
  }, {
    key: "update",
    value: function update() {
      var addNewCard = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
      this.updateView(addNewCard);
    }
  }, {
    key: "updateView",
    value: function updateView(addNewCard) {
      if (this.myView) {
    ...
    key: "removeCard",
    value: function () {
      var _removeCard = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(id) {
        var newList;
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                this.list = newList;
                _context.next = 4;
                return (0,_fetch_js__WEBPACK_IMPORTED_MODULE_1__.RequestUpdateCards)(newList);
    ...
    key: "learnMoreCard",
    value: function learnMoreCard(id) {
      this.form = "current";
      var card = this.list.find(function (item) {
        return item.id === id;
      });
    ...
    key: "saveNewCard",
    value: function () {
      var _saveNewCard = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(newCard) {
        var newList;
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                newList = _toConsumableArray(this.list);
              ...
              case 5:
                //запрос на сервер - обновляем список карт
                this.cancelNewCard();
                this.update();
      ...
      function saveNewCard(_x2) {
        return _saveNewCard.apply(this, arguments);
      }
    ...
    key: "saveCurrentCard",
    value: function () {
      var _saveCurrentCard = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(currentCard) {
        var _this = this;
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                newList = _toConsumableArray(this.list);
                index = newList.findIndex(function (item) {
                  return item.id === _this.currentCard.id;
                });
                newList[index] = currentCard;
                this.list = _toConsumableArray(newList);
                _context3.next = 6;
                return (0,_fetch_js__WEBPACK_IMPORTED_MODULE_1__.RequestUpdateCards)(newList);
      ...
      function saveCurrentCard(_x3) {
        return _saveCurrentCard.apply(this, arguments);
      }

      return saveCurrentCard;
    }()
  }, {
    key: "cancelNewCard",
    value: function cancelNewCard() {
    ...
    key: "errorSaveCard",
    value: function errorSaveCard(errors) {
      this.myView.updateErrorNewCard(errors);
    }
  }, {
    key: "errorField",
    value: function errorField(errors) {
      this.myView.updateErrorField(errors);
    }
  }, {
    key: "cancelValidateField",
    value: function cancelValidateField(field) {
      this.myView.cancelValidateField(field);
    }
  }, {
    key: "addLogoNewCard",
    value: function addLogoNewCard(logo) {
    ...
    value: function validateField(field) {
      var objectForValidation = {};
      _constants_js__WEBPACK_IMPORTED_MODULE_3__.dataForForm.forEach(function (element) {
        field.className === element.name && (objectForValidation[element.name] = field.value);
      });

      var errors = (0,_validation_js__WEBPACK_IMPORTED_MODULE_2__.validationNewCard)(objectForValidation);
    ...
    key: "validationNewCard",
    value: function () {
      var _validationNewCard2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(formNewCard) {
        var _this2 = this;

        var objectForValidation, errors, sameCard, list, currentCardIndex, newCard;
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                objectForValidation = {};
                _constants_js__WEBPACK_IMPORTED_MODULE_3__.dataForForm.forEach(function (element) {
                  return objectForValidation[element.name] = formNewCard.querySelector("." + element.name).value;
                });
                errors = (0,_validation_js__WEBPACK_IMPORTED_MODULE_2__.validationNewCard)(objectForValidation);

                if (this.form === "new") {
                  sameCard = this.list.find(function (item) {
                    return objectForValidation.number === item.id;
                  });
                } else if (this.form === "current") {
                  list = _toConsumableArray(this.list);
                  currentCardIndex = list.findIndex(function (item) {
                    return _this2.currentCard.id === item.id;
                  });
                  list.splice(currentCardIndex, 1);
                  sameCard = list.find(function (item) {
                    return objectForValidation.number === item.id;
                  });
                }
                ...
                _context4.next = 10;
                return this.saveNewCard(newCard);
              ...
              case 12:
                _context4.next = 14;
                return this.saveCurrentCard(newCard);
              ...
              case 16:
                if (sameCard) {
                  this.cancelNewCard();
                  alert("Ошибка при сохранении! Карта c таким номером уже есть в списке!");
                } else if (!this.logoNewCard) {
                  this.cancelNewCard();
                  alert("Ошибка при сохранении! Карта должна соответствовать платежной системе Visa или МаsterCard");
                }
      ...
      function validationNewCard(_x4) {
        return _validationNewCard2.apply(this, arguments);
      }
    ...
    key: "initializationLogo",
    value: function initializationLogo(value) {
      var logo = (0,_validation_js__WEBPACK_IMPORTED_MODULE_2__.validationLogo)(value);
...
/* harmony import */ var _form_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./form.js */ "./js/form.js");
...
var View = /*#__PURE__*/function () {
  ...
  _createClass(View, [{
    ...
    key: "buildCurrentList",
    value: function buildCurrentList(list) {
      var myList = "";
      list.forEach(function (item) {
        return myList += (0,_card_js__WEBPACK_IMPORTED_MODULE_0__.createCard)(item);
      });
      this.myElementList.innerHTML = myList;
    }
  }, {
    key: "destroyFormForNewCard",
    value: function destroyFormForNewCard() {
      var newCard = this.myElementApp.querySelector("#newCard");
      var form = newCard.firstChild;
      newCard.removeChild(form);
    }
  }, {
    key: "update",
    value: function update(list, addNewCard) {
      this.buildCurrentList(list);
      addNewCard && (0,_form_js__WEBPACK_IMPORTED_MODULE_1__.buildFormForNewCard)();
    }
  }, {
    key: "updateLearnMoreCard",
    value: function updateLearnMoreCard(card) {
      (0,_form_js__WEBPACK_IMPORTED_MODULE_1__.buildFormForNewCard)(card);
    }
  }, {
    key: "updateCancelNewCard",
    value: function updateCancelNewCard() {
      this.destroyFormForNewCard();
    }
  }, {
    key: "updateErrorNewCard",
    value: function updateErrorNewCard(errors) {
      var _this = this;

      errors.forEach(function (error) {
        var keys = Object.keys(error);

        var span = _this.myElementApp.querySelector("." + keys[0] + "Span");

        span.innerHTML = error[keys[0]];
      });
    }
  }, {
    key: "updateErrorField",
    value: function updateErrorField(errors) {
      this.updateErrorNewCard(errors);
    }
  }, {
    key: "cancelValidateField",
    value: function cancelValidateField(field) {
      var span = this.myElementApp.querySelector("." + field.getAttribute("class") + "Span");
      span.innerHTML = "";
    }
  }, {
    key: "addLogoNewCard",
    value: function addLogoNewCard(logo) {
      var logoElem = document.getElementById("logoNewCard");
      logoElem.src = logo ? "img/logo-".concat(logo, ".png") : "";
    }
  }, {
    key: "deleteCard",
    value: function deleteCard(id) {
      var cardDelete = document.getElementById(id);
      cardDelete.setAttribute("class", "card deleteCard");
      cardDelete.addEventListener("transitionend", function () {
...
/* harmony export */ });
/* harmony import */ var _css_card_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../css/card.css */ "./css/card.css");
...
function createCard(item) {
  var cardHTML = "";
  var logo = "img/logo-".concat(item.logo, ".png");
  var logoImgStyle = item.logo === "visa" ? "height:33%" : "height:80%";
  var number = item.number.substr(0, 4) + " " + item.number.substr(4, 4) + " " + item.number.substr(8, 4) + " " + item.number.substr(12, 4);
  var comment = item.comment;
  cardHTML += "<div id=".concat(item.id, " class='card'>");
  cardHTML += "<div class='column'>";
  cardHTML += "<div class='string'>";
  cardHTML += "<div class='logo'>";
  cardHTML += "<img src=".concat(logo, " style=").concat(logoImgStyle, ">");
  cardHTML += "</div>";
  cardHTML += "<div class='number'>".concat(number, "</div>");
  cardHTML += "</div>";
  cardHTML += "<div class='comment'>".concat(comment, "</div>");
  cardHTML += "</div>";
  cardHTML += "<div class='delete'>";
  cardHTML += "<svg class='remove' xmlns='http://www.w3.org/2000/svg' x='0px' y='0px' viewBox='0 0 22.88 22.88' xml:space='preserve'><path fill='#1E201D;' d='M0.324,1.909c-0.429-0.429-0.429-1.143,0-1.587c0.444-0.429,1.143-0.429,1.587,0l9.523,9.539 l9.539-9.539c0.429-0.429,1.143-0.429,1.571,0c0.444,0.444,0.444,1.159,0,1.587l-9.523,9.524l9.523,9.539c0.444,0.429,0.444,1.143,0,1.587c-0.429,0.429-1.143,0.429-1.571,0l-9.539-9.539l-9.523,9.539c-0.444,0.429-1.143,0.429-1.587,0c-0.429-0.444-0.429-1.159,0-1.587l9.523-9.539L0.324,1.909z'/></svg>";
  cardHTML += "</div>";
  cardHTML += "</div>";
  return cardHTML;
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "wayDB": () => (/* binding */ wayDB),
/* harmony export */   "secretKey": () => (/* binding */ secretKey),
/* harmony export */   "dataForForm": () => (/* binding */ dataForForm)
/* harmony export */ });
 //URLs

var wayDB = "https://api.jsonbin.io/b/61d86d112362237a3a33f5bf";
var secretKey = "$2b$10$XjxC.kAIp/B6vt0r1oWeLO6dkxXYMLYOqflTMkpcQ3GAPcKWEcjYi"; //Данные для построения формы
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "RequestGetCards": () => (/* binding */ RequestGetCards),
/* harmony export */   "RequestUpdateCards": () => (/* binding */ RequestUpdateCards)
/* harmony export */ });
/* harmony import */ var regenerator_runtime_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! regenerator-runtime/runtime */ "./node_modules/regenerator-runtime/runtime.js");
/* harmony import */ var regenerator_runtime_runtime__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(regenerator_runtime_runtime__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _constants_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./constants.js */ "./js/constants.js");
...
function RequestGetCards() {
  return _RequestGetCards.apply(this, arguments);
} //запрос на сервер об обновлении списка карт


function _RequestGetCards() {
  _RequestGetCards = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var response, data;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return fetch(_constants_js__WEBPACK_IMPORTED_MODULE_1__.wayDB, {
              method: "GET",
              headers: {
                "Content-Type": "application/json",
                "secret-key": _constants_js__WEBPACK_IMPORTED_MODULE_1__.secretKey
              }
            });
...
function RequestUpdateCards(_x) {
  return _RequestUpdateCards.apply(this, arguments);
}

function _RequestUpdateCards() {
  _RequestUpdateCards = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(newCards) {
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "buildFormForNewCard": () => (/* binding */ buildFormForNewCard)
/* harmony export */ });
...
function buildFormForNewCard(card) {
  ...
  var newGlass = document.createElement("div");
  ...
  card ? newImg.setAttribute("src", "img/logo-".concat(card.logo, ".png")) : newImg.setAttribute("src", "");
  newImg.setAttribute("id", "logoNewCard");
  _constants_js__WEBPACK_IMPORTED_MODULE_1__.dataForForm.forEach(function (item) {
    ...
    keys.forEach(function (key) {
      switch (key) {
        case "label":
          ...
          var newTextLabel = document.createTextNode(item[key]);
          newTr.appendChild(newLabel);
          newLabel.appendChild(newTextLabel);
          break;

        case "kind":
          var atrSize = item["characters"];
          var typeField = item["type"];
          var nameField = item["name"];
          var newField = document.createElement(typeField);
          var newSpan = document.createElement("span");
          newTr.appendChild(newField);
          newTr.appendChild(newSpan);
          nameField === "comment" && newField.setAttribute("rows", 5);
          nameField === "comment" && newField.setAttribute("maxlength", atrSize);
          var maskOptions = {
            mask: "0000000000000000"
          };
          var mask = nameField === "number" && (0,imask__WEBPACK_IMPORTED_MODULE_0__["default"])(newField, maskOptions);
          ...
          nameField === "comment" && card && (newField.innerHTML = card[nameField]);
          break;
      }
    });
  });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "validationNewCard": () => (/* binding */ validationNewCard),
/* harmony export */   "validationLogo": () => (/* binding */ validationLogo)
/* harmony export */ });
...
var validationLogo = function validationLogo(value) {
  if (/^4/.test(value)) {
    //---------------------------VISA
    return "visa";
  } else if (/^(51|52|53|54|55)/.test(value)) {
    //-----MasterCard
    return "mastercard";
  } else {
    return null;
...
function validationNewCard(objectForValidation) {
  var keys = Object.keys(objectForValidation);
  var errors = [];
  keys.forEach(function (key) {
    var validField;
    ...
    if (key === "number") {
      ...
      !validField && errors.push(_defineProperty({}, "number", "Номер должен состоять из 16 цифр"));
    }

    if (key === "comment") {
      validField = comment(objectForValidation["comment"]);
      !validField && errors.push(_defineProperty({}, "comment", "Должно быть не более 1024 знаков"));
    }
  });
  return errors;
}
